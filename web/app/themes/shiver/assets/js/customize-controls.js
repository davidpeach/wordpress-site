( function( $ ) {
	...
	$( '#customize-control-shiver_color_schemes_selector .shiver-color-scheme-control input' ).live( 'change', function() {
		...
		if ( $( this ).is( ':checked' ) ) {
			...
			$.ajax( {
			url: 	shiver_ajax_get_color_scheme_colors.ajaxurl,
			type: 	'post',
			data: {
				action: 		'shiver_ajax_get_color_scheme_colors',

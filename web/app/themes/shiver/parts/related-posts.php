...
$enable_related_posts = get_theme_mod( 'shiver_enable_related_posts', true );
...
if ( is_single() && $enable_related_posts ) :
	...
	$posts_per_page = absint( get_theme_mod( 'shiver_post_grid_columns', 2 ) );
	...
	if ( $related_posts ) :
		...
		<div class="related-posts section-inner">
			...
			<h3 class="related-posts-title"><?php esc_html_e( 'Related Posts', 'shiver' ); ?></h3>

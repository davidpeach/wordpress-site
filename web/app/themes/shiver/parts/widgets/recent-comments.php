...
class shiver_Recent_Comments extends WP_Widget {

	function __construct() {
		$widget_ops = array(
			'classname' 	=> 'widget_shiver_recent_comments',
			'description' 	=> __( 'Displays recent comments with user avatars.', 'shiver' ),
		);
		parent::__construct( 'widget_shiver_recent_comments', __( 'Recent Comments', 'shiver' ), $widget_ops );
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'widget_title' ) ); ?>"><?php  esc_html_e( 'Title', 'shiver' ); ?>:
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'number_of_comments' ); ?>"><?php esc_html_e( 'Number of comments to display', 'shiver' ); ?>:

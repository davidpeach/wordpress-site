...
<html class="no-js" <?php language_attributes(); ?>>
	...
	<body <?php body_class(); ?>>
		...
		<a class="skip-link faux-button" href="#site-content"><?php _e( 'Skip to the content', 'shiver' ); ?></a>

		<?php

		$only_content_templates = array( 'template-only-content.php', 'template-full-width-only-content.php' );
		$show_header = apply_filters( 'shiver_show_header_footer_on_only_content_templates', false );
		...
		if ( ! is_page_template( $only_content_templates ) || $show_header ) :
			...
			if ( get_theme_mod( 'shiver_sticky_header', false ) ) {
					...
					<div class="section-inner">
						...
						<div class="header-navigation-wrapper">
							...
							<div class="header-toggles hide-no-js">
								...
								$disable_header_search = get_theme_mod( 'shiver_disable_header_search', false );

								if ( ! $disable_header_search ) : ?>

									<a href="#" class="toggle search-toggle" data-toggle-target=".search-modal" data-toggle-screen-lock="true" data-toggle-body-class="showing-search-modal" data-set-focus=".search-modal .search-field" aria-pressed="false">
										<div class="toggle-text">
											<?php esc_html_e( 'Search', 'shiver' ); ?>
										</div>
										<?php shiver_the_theme_svg( 'search' ); ?>
									</a><!-- .search-toggle -->

		...
		$show_footer = apply_filters( 'shiver_show_header_footer_on_only_content_templates', false );
			...
			<footer class="" id="site-footer" role="contentinfo">
				...
				<div class="footer-inner section-inner<?php echo esc_attr( $footer_inner_classes ); ?>">
					...
					<div class="footer-credits">
						...
						<p class="footer-copyright">&copy; <?php echo esc_html( date_i18n( __( 'Y', 'shiver' ) ) ); ?> <a href="<?php echo esc_url( home_url() ); ?>"><?php echo bloginfo( 'name' ); ?></a></p>

						<p class="theme-credits color-secondary">
							<?php
							/* Translators: $s = name of the theme developer */
							printf( esc_html_x( 'Theme by %s', 'Translators: $s = name of the theme developer', 'shiver' ), '<a href="https://www.andersnoren.se">' . esc_html__( 'Anders Norén', 'shiver' ) . '</a>' ); ?>
						</p><!-- .theme-credits -->

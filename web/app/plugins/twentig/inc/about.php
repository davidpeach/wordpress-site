	...
	<div class="wrap tw-about__container">
		<div class="tw-about__header">
			<nav class="tw-about__header-navigation" aria-label="<?php esc_attr_e( 'Primary menu' ); ?>">
				...
				<a href="https://twentig.com/newsletter" target="_blank"><?php esc_html_e( 'Get more', 'twentig' ); ?></a>
			</nav>
		</div>
		...
		<div class="tw-about__section is-feature">
			<div class="tw-about__section-inner">
				...
				<p><?php esc_html_e( 'From advanced Twenty Twenty customization to enhanced blocks to pre‑designed layouts, you’ve got what you need to create a beautiful website.', 'twentig' ); ?></p>
			</div>
		</div>
			...
			<div class="tw-about__section-inner">
				...
				<div class="tw-about__columns has-2-columns">
					<div class="column">
						...
						<p><?php esc_html_e( 'We added the right amount of features to the WordPress core blocks. So you can easily customize your blocks to fit your needs with just a few clicks. Enjoy a seamless and familiar experience.', 'twentig' ); ?></p>
					</div>
					<div class="column">
			...
			<div class="tw-about__section-inner">
				...
				<div class="tw-about__columns has-2-columns">
					<div class="column">
						...
						<p><?php esc_html_e( 'Choose from a variety of versatile block patterns and page layouts that you can mix and match to fit your project. Our library is designed to enable a wide range of uses and endless design possibilities.', 'twentig' ); ?></p>
					</div>
					<div class="column">
		...
		<div class="tw-about__section is-cta">
			<div class="tw-about__section-inner">
				...
				<p><?php esc_html_e( 'Receive exclusive pre-designed layouts, resources, and tips — for free.', 'twentig' ); ?></p>
				<a href="https://twentig.com/newsletter" class="button button-primary" target="_blank"><?php esc_html_e( 'Subscribe now', 'twentig' ); ?></a>
			</div>
		</div>
		...
		<div class="tw-about__footer">
			<p class="tw-rate-plugin">
				...
				echo sprintf(
					...
					__( 'Enjoying Twentig? Rate it <a href="%1$s" class="tw-rate-stars" target="_blank">★★★★★</a> on <a href="%2$s" target="_blank">WordPress</a>.', 'twentig' ),
			...
			<ul class="tw-footer-links">
				...
				<li>
					<a href="https://www.youtube.com/channel/UCHZglgs5eTxkpRFl2r5RsGA" target="_blank">
...
function twentig_render_settings_page() {
	...
	<p style="margin-top:24px; font-style:italic; color:#555d66;">
		<?php
		echo sprintf(
			/* translators: %s: https://wordpress.org/support/plugin/twentig/reviews/?filter=5 */
			__( 'Enjoying Twentig? Rate it on <a href="%s" target="_blank">WordPress</a>.', 'twentig' ),
			'https://wordpress.org/support/plugin/twentig/reviews/?filter=5'
		);
		?>
	</p>
...
function twentig_admin_enqueue_about_scripts() {
	if ( in_array( get_current_screen()->base, array( 'toplevel_page_twentig' ), true ) ) {
		wp_enqueue_style( 'twentig-about', plugins_url( 'dist/css/about.css', __DIR__ ), false, '1.0.0' );
	}
}

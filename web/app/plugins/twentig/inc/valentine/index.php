...
function twentig_valentine_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control(
		new WP_Customize_Cropped_Image_Control(
			...
			array(
				...
				'description'   => __( 'Displayed on the Cover Template.', 'twentig' ),
	...
	$wp_customize->add_control(
		'twentig_logo_mobile_width',
		array(
			'label'       => __( 'Mobile: Logo Width (px)', 'twentig' ),
			'section'     => 'title_tagline',
			'type'        => 'number',
			'input_attrs' => array(
				'min'  => '20',
	...
	$wp_customize->get_control( 'accent_hue_active' )->choices = array(
		...
		'hex'     => __( 'Custom Hexadecimal', 'twentig' ),
	);
	...
	$wp_customize->add_control(
		'twentig_cover_page_scroll_indicator',
		array(
			'label'   => __( 'Display scroll indicator on page cover template', 'twentig' ),
			'section' => 'cover_template_options',
			'type'    => 'checkbox',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'type'    => 'select',
			'choices' => array(
				'sans-serif' => __( 'sans-serif', 'twentig' ),
				'serif'      => __( 'serif', 'twentig' ),
				'monospace'  => __( 'monospace', 'twentig' ),
				'cursive'    => __( 'cursive', 'twentig' ),
			),
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'type'    => 'select',
			'choices' => array(
				'400' => __( 'Regular 400', 'twentig' ),
				'700' => __( 'Bold 700', 'twentig' ),
			),
		)
	);
	...
	$wp_customize->add_control(
		'twentig_logo_mobile_font_size',
		array(
			'label'       => __( 'Mobile: Site Title Font Size (px)', 'twentig' ),
			'section'     => 'twentig_fonts_section',
			'type'        => 'number',
			'input_attrs' => array(
				'min'  => '14',
	...
	$wp_customize->add_control(
		...
		array(
			...
			'choices' => array(
				''            => __( 'Default' ),
				'inline-left' => __( 'Inline Menu Left', 'twentig' ),
				'stack'       => __( 'Stack Center', 'twentig' ),
			),
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'type'    => 'select',
			'choices' => array(
				'wide'  => __( 'Wide (1200px)', 'twentig' ),
				'wider' => __( 'Wider (1680px)', 'twentig' ),
	...
	$wp_customize->add_control(
		'twentig_menu_hover',
		array(
			'label'   => __( 'Menu Hover/Active Link', 'twentig' ),
			'section' => 'twentig_header_section',
			'type'    => 'select',
			'choices' => array(
				'none'      => __( 'None', 'twentig' ),
				'underline' => __( 'Underline', 'twentig' ),
				'border'    => __( 'Border', 'twentig' ),
	...
	$wp_customize->add_control(
		new Twentig_Customize_Title_Control(
			...
			array(
				'label'    => __( 'Toggle Buttons', 'twentig' ),
				'section'  => 'twentig_header_section',
				'settings' => array(),
			)
		)
	...
	$wp_customize->add_control(
		'twentig_burger_icon',
		array(
			'label'   => __( 'Replace the toggle menu icon (horizontal dots) with a hamburger icon', 'twentig' ),
			'section' => 'twentig_header_section',
			'type'    => 'checkbox',
		)
	);
	...
	$wp_customize->add_control(
		'twentig_toggle_label',
		array(
			'label'   => __( 'Display label for menu and search toggle buttons', 'twentig' ),
			'section' => 'twentig_header_section',
			'type'    => 'checkbox',
		)
	);
		...
		new Twentig_Customize_Title_Control(
			...
			array(
				...
				'description' => sprintf(
					...
					__( 'Visit the <a href="%s">Additional Settings panel</a> to set the locations and style of social icons.', 'twentig' ),
	...
	$wp_customize->add_control(
		...
		array(
			...
			'choices' => array(
				''              => __( 'Default', 'twentig' ),
				'inline-left'   => __( 'Inline Menu Left', 'twentig' ),
				'inline-right'  => __( 'Inline Menu Right', 'twentig' ),
				'inline-center' => __( 'Inline Center', 'twentig' ),
				'stack'         => __( 'Stack', 'twentig' ),
	...
	$wp_customize->add_control(
		'twentig_footer_font_size',
		array(
			'label'   => __( 'Footer Text Scale', 'twentig' ),
			'section' => 'twentig_footer_section',
			'type'    => 'select',
			'choices' => array(
				'small'  => __( 'Small', 'twentig' ),
	...
	$wp_customize->add_control(
		'twentig_footer_credit_text',
		array(
			'label'       => __( 'Custom Footer Credit', 'twentig' ),
			'section'     => 'twentig_footer_section',
			'type'        => 'text',
	...
	$wp_customize->add_control(
		...
		array(
			...
			'choices'     => array(
				''             => __( 'Default', 'twentig' ),
				'narrow-image' => __( 'Narrow Image', 'twentig' ),
				'full-image'   => __( 'Full Width Image', 'twentig' ),
				'no-image'     => __( 'No Image', 'twentig' ),
			),
			'description' => sprintf(
				/* translators: link to cover template panel */
				__( 'Visit the <a href="%s">Cover Template panel</a> to set the style of the cover layout.', 'twentig' ),
	...
	$wp_customize->add_control(
		new Twentig_Customize_Title_Control(
			$wp_customize,
			'twentig_page_section_title_others',
			array(
				'label'    => __( 'Search & 404 Pages', 'twentig' ),
				'section'  => 'twentig_page_section',
				'settings' => array(),
			)
		)
	...
	$wp_customize->add_control(
		new Twentig_Customize_Dropdown_Pages_Private_Control(
			...
			array(
				...
				'section'     => 'twentig_page_section',
				'description' => __( "To set a Custom 404, you'll first need to create a private page (to prevent search engines from indexing this page).", 'twentig' ),
			)
		)
	);
	...
	$wp_customize->add_control(
		new Twentig_Customize_Title_Control(
			...
			array(
				'label'    => __( 'Posts Page & Archives', 'twentig' ),
	...
	$wp_customize->add_control(
		...
		array(
			...
			'choices' => array(
				...
				'grid-card'  => __( 'Grid Card', 'twentig' ),
			),
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'description' => sprintf(
				/* translators: link to theme options panel */
				__( 'Set post content in <a href="%s">Theme Options</a>.', 'twentig' ),
	...
	$wp_customize->add_control(
		new Twentig_Customize_Title_Control(
			...
			array(
				'label'    => __( 'Elements Styles', 'twentig' ),
	...
	$wp_customize->add_control(
		...
		array(
			...
			'type'    => 'select',
			'choices' => array(
				'square'  => __( 'Square', 'twentig' ),
				'rounded' => __( 'Rounded', 'twentig' ),
				'pill'    => __( 'Pill', 'twentig' ),
			),
		)
	);
	...
	$wp_customize->add_control(
		'twentig_button_uppercase',
		array(
			'label'       => __( 'Button Uppercase', 'twentig' ),
			'section'     => 'twentig_additional_section',
			'type'        => 'checkbox',
			'description' => __( 'Make the button block and the form button uppercase.', 'twentig' ),
		)
	);
	...
	$wp_customize->add_control(
		new Twentig_Customize_Title_Control(
			...
			array(
				'label'    => __( 'Socials Icons', 'twentig' ),
				'section'  => 'twentig_additional_section',
				'settings' => array(),
			)
		)
		...
		new Twentig_Customize_Checkbox_Multiple_Control(
			...
			array(
				...
				'choices' => array(
					...
					'modal-desktop' => __( 'Desktop Expanded Menu Panel', 'twentig' ),
					'modal-mobile'  => __( 'Mobile Menu Panel', 'twentig' ),
	...
	$wp_customize->add_control(
		...
		array(
			...
			'choices' => array(
				...
				'logos-only-large' => __( 'Logos Only - Large', 'twentig' ),
			),
		)
	);
...
function twentig_theme_styles() {
	...
	wp_dequeue_style('twentig-theme-logo-font');

 ...
 * @param int    $post_id The post ID.
 */
function twentig_add_link_to_featured_image( $html, $post_id ) {
...
add_filter( 'post_thumbnail_html', 'twentig_add_link_to_featured_image', 10, 2 );
 ...
 */
function twentig_post_nav_background() {

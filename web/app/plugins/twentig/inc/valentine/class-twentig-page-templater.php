...
class Twentig_Page_Templater {
	...
	private function __construct() {
		...
		$this->templates = array(
			'tw-no-title.php'                 => __( 'Twentig - No title', 'twentig' ),
			'tw-no-header-footer.php'         => __( 'Twentig - No header, no footer', 'twentig' ),
			'tw-header-transparent.php'       => __( 'Twentig - Transparent header', 'twentig' ),
			'tw-header-transparent-light.php' => __( 'Twentig - Transparent header light', 'twentig' ),
		);

...
twentig_register_block_pattern(
	'twentig/gallery-stacked',
	array(
		'title'      => __( 'Gallery Stacked', 'twentig' ),
...
twentig_register_block_pattern(
	'twentig/gallery-stretched',
	array(
		'title'      => __( 'Gallery Stretched', 'twentig' ),
		'categories' => array( 'gallery' ),
...
twentig_register_block_pattern(
	'twentig/gallery-horizontally-centered',
	array(
		'title'      => __( 'Gallery Horizontally Centered', 'twentig' ),
		'categories' => array( 'gallery' ),
...
twentig_register_block_pattern(
	'twentig/gallery-4-columns-frame',
	array(
		'title'      => __( 'Gallery 4 Columns: Frame', 'twentig' ),
		'categories' => array( 'gallery' ),

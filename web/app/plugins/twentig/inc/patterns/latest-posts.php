...
twentig_register_block_pattern(
	'twentig/posts-list-separator',
	array(
		'title'      => __( 'Posts List: Separator', 'twentig' ),
		'categories' => array( 'latest-posts' ),
...
twentig_register_block_pattern(
	'twentig/posts-list-right-image',
	array(
		'title'      => __( 'Posts List: Right Image', 'twentig' ),
		'categories' => array( 'latest-posts' ),
...
twentig_register_block_pattern(
	'twentig/posts-list-left-image',
	array(
		'title'      => __( 'Posts List: Left Image', 'twentig' ),
		'categories' => array( 'latest-posts' ),
...
twentig_register_block_pattern(
	'twentig/posts-2-columns-left-image',
	array(
		'title'      => __( 'Posts 2 Columns: Left Image', 'twentig' ),
		'categories' => array( 'latest-posts' ),
...
twentig_register_block_pattern(
	...
	array(
		'title'      => __( 'Posts 3 Column Cards', 'twentig' ),
		'categories' => array( 'latest-posts' ),
...
twentig_register_block_pattern(
	...
	array(
		'title'      => __( 'Posts 3 Column Cards: Text Only', 'twentig' ),
		'categories' => array( 'latest-posts' ),

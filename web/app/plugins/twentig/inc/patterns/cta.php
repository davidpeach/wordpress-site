...
twentig_register_block_pattern(
	'twentig/cta-background-color',
	array(
		'title'      => __( 'CTA Background Color', 'twentig' ),
...
twentig_register_block_pattern(
	'twentig/cta-background-color-with-text',
	array(
		'title'      => __( 'CTA Background Color with Text', 'twentig' ),
		'categories' => array( 'cta' ),
...
twentig_register_block_pattern(
	'twentig/wide-cta-gradient',
	array(
		'title'      => __( 'Wide CTA Gradient', 'twentig' ),
		'categories' => array( 'cta' ),
		'content'    => "<!-- wp:group {\"align\":\"full\"} -->\n<div class=\"wp-block-group alignfull\"><div class=\"wp-block-group__inner-container\"><!-- wp:cover {\"gradient\":\"vivid-cyan-blue-to-vivid-purple\",\"align\":\"wide\"} -->\n<div class=\"wp-block-cover alignwide has-background-dim has-background-gradient has-vivid-cyan-blue-to-vivid-purple-gradient-background\"><div class=\"wp-block-cover__inner-container\"><!-- wp:heading {\"align\":\"center\"} -->\n<h2 class=\"has-text-align-center\">" . esc_html_x( 'Write a heading', 'Block pattern content', 'twentig' ) . "</h2>\n<!-- /wp:heading -->\n\n<!-- wp:paragraph {\"align\":\"center\",\"fontSize\":\"medium\"} -->\n<p class=\"has-text-align-center has-medium-font-size\"> Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod tempor incididunt ut labore.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:buttons {\"align\":\"center\"} -->\n<div class=\"wp-block-buttons aligncenter\"><!-- wp:button {\"customBackgroundColor\":\"#ffffff\",\"customTextColor\":\"#1c1c1c\"} -->\n<div class=\"wp-block-button\"><a class=\"wp-block-button__link has-text-color has-background\" style=\"background-color:#ffffff;color:#1c1c1c\">" . esc_html_x( 'Get started', 'Block pattern content', 'twentig' ) . "</a></div>\n<!-- /wp:button --></div>\n<!-- /wp:buttons --></div></div>\n<!-- /wp:cover --></div></div>\n<!-- /wp:group -->",
	)
);

twentig_register_block_pattern(
	'twentig/cta-gradient-with-buttons',
	array(
		'title'      => __( 'CTA Gradient with Buttons', 'twentig' ),
		'categories' => array( 'cta' ),
...
twentig_register_block_pattern(
	'twentig/cta-with-left-heading',
	array(
		'title'      => __( 'CTA with Left Heading', 'twentig' ),
		'categories' => array( 'cta' ),
...
twentig_register_block_pattern(
	'twentig/cta-with-right-image',
	array(
		'title'      => __( 'CTA with Right Image', 'twentig' ),
		'categories' => array( 'cta' ),
...
twentig_register_block_pattern(
	'twentig/cta-gradient-with-2-columns',
	array(
		'title'      => __( 'CTA Gradient with 2 Columns', 'twentig' ),
		'categories' => array( 'cta' ),
...
twentig_register_block_pattern(
	'twentig/cta-2-column-covers',
	array(
		'title'      => __( 'CTA 2 Column Covers', 'twentig' ),
		'categories' => array( 'cta' ),

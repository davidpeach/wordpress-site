...
twentig_register_block_pattern(
	'twentig/hero-with-background-color',
	array(
		'title'      => __( 'Hero with Background Color', 'twentig' ),
...
twentig_register_block_pattern(
	'twentig/hero-with-right-image-eyebrow-title',
	array(
		'title'      => __( 'Hero with Right Image: Eyebrow Title', 'twentig' ),
		'categories' => array( 'hero' ),
...
twentig_register_block_pattern(
	'twentig/hero-with-right-image-full-width',
	array(
		'title'      => __( 'Hero with Right Image: Full Width', 'twentig' ),
		'categories' => array( 'hero' ),
...
twentig_register_block_pattern(
	...
	array(
		...
		'categories' => array( 'hero' ),
		'content'    => "<!-- wp:cover {\"url\":\"" . twentig_get_pattern_asset( 'wide.jpg' ) . "\",\"align\":\"full\"} -->\n<div class=\"wp-block-cover alignfull has-background-dim\" style=\"background-image:url(" . twentig_get_pattern_asset( 'wide.jpg' ) . ")\"><div class=\"wp-block-cover__inner-container\"><!-- wp:heading {\"align\":\"center\",\"level\":1,\"className\":\"tw-text-wide\"} -->\n<h1 class=\"has-text-align-center tw-text-wide\">" . esc_html_x( 'Write the page title', 'Block pattern content', 'twentig' ) . "</h1>\n<!-- /wp:heading -->\n\n<!-- wp:paragraph {\"align\":\"center\",\"fontSize\":\"large\"} -->\n<p class=\"has-text-align-center has-large-font-size\">Lorem ipsum dolor sit amet commodo erat adipiscing elit. Sed do eiusmod ut tempor incididunt.</p>\n<!-- /wp:paragraph --></div></div>\n<!-- /wp:cover -->",
	)
);

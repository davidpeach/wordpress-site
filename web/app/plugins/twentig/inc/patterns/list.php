...
twentig_register_block_pattern(
	'twentig/list-and-left-heading',
	array(
		'title'      => __( 'List and Left Heading', 'twentig' ),
		'categories' => array( 'list' ),
...
twentig_register_block_pattern(
	'twentig/list-with-emphasized-card',
	array(
		'title'      => __( 'List with Emphasized Card', 'twentig' ),
		'categories' => array( 'list' ),
...
twentig_register_block_pattern(
	'twentig/list-and-left-image',
	array(
		'title'      => __( 'List and Left Image', 'twentig' ),
		'categories' => array( 'list' ),
...
twentig_register_block_pattern(
	'twentig/list-and-left-image-bold-text',
	array(
		'title'      => __( 'List and Left Image: Bold Text', 'twentig' ),
		'categories' => array( 'list' ),
...
twentig_register_block_pattern(
	'twentig/list-and-image-alternating',
	array(
		'title'      => __( 'List and Image: Alternating', 'twentig' ),
		'categories' => array( 'list' ),
...
twentig_register_block_pattern(
	'twentig/list-2-columns',
	array(
		'title'      => __( 'List 2 Columns', 'twentig' ),
		'categories' => array( 'list' ),
...
twentig_register_block_pattern(
	'twentig/list-3-columns',
	array(
		'title'      => __( 'List 3 Columns', 'twentig' ),
		'categories' => array( 'list' ),
...
twentig_register_block_pattern(
	'twentig/list-3-columns-border',
	array(
		'title'      => __( 'List 3 Columns: Border', 'twentig' ),
		'categories' => array( 'list' ),
...
twentig_register_block_pattern(
	...
	array(
		...
		'categories' => array( 'list' ),
		'content'    => "<!-- wp:group {\"align\":\"full\"} -->\n<div class=\"wp-block-group alignfull\"><div class=\"wp-block-group__inner-container\"><!-- wp:heading {\"align\":\"center\"} -->\n<h2 class=\"has-text-align-center\">" . esc_html_x( 'Our services', 'Block pattern content', 'twentig' ) . "</h2>\n<!-- /wp:heading -->\n\n<!-- wp:list {\"className\":\"tw-mt-6 has-text-align-center has-larger-font-size is-style-tw-inline tw-text-wide\"} -->\n<ul class=\"tw-mt-6 has-text-align-center has-larger-font-size is-style-tw-inline tw-text-wide\"><li>Branding</li><li>Creative Direction</li><li>Digital Design</li><li>Customer Experience</li><li>Film</li><li>Visual Design</li><li>Photography</li><li>eCommerce</li><li>Web Design</li><li>Marketing</li><li>Motion Graphics</li><li>Social Strategy</li><li>Copywriting</li></ul>\n<!-- /wp:list --></div></div>\n<!-- /wp:group -->",
	)
);
